...
VJXV8_EXPORT_ENTITY_CLASS(VJXQtVideoCaptureEntity);
...
- (id)init;
- (void)startCapture:(VJXQtVideoCaptureEntity *)controller;
- (void)stopCapture;
- (NSSize)size;
@end
...
@implementation VJXQtVideoCaptureEntity : VJXVideoEntity
