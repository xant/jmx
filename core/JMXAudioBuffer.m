...
{
    return [[[JMXAudioBuffer alloc] initWithCoreAudioBuffer:audioBuffer andFormat:audioFormat] autorelease];
}

+ (id)audioBufferWithCoreAudioBufferList:(AudioBufferList *)audioBufferList andFormat:(AudioStreamBasicDescription *)audioFormat
{
    return [[[JMXAudioBuffer alloc] initWithCoreAudioBufferList:audioBufferList andFormat:audioFormat] autorelease];
}
...
{
    return [[[JMXAudioBuffer alloc] initWithCoreAudioBufferList:audioBufferList andFormat:audioFormat copy:wantsCopy freeOnRelease:wantsFree] autorelease];
}
...
- (id)initWithCoreAudioBufferList:(AudioBufferList *)audioBufferList andFormat:(AudioStreamBasicDescription *)audioFormat copy:(BOOL)wantsCopy freeOnRelease:(BOOL)wantsFree
{
    ...
    if (self) {
        ...
        if (audioFormat)
            format = [[JMXAudioFormat formatWithAudioStreamDescription:*audioFormat] retain];
        if (wantsCopy) {
