...
VJXV8_EXPORT_ENTITY_CLASS(VJXAudioFileEntity);

@implementation VJXAudioFileEntity
...
static v8::Handle<Value> open(const Arguments& args)
{
    ...
    VJXAudioFileEntity *entity = (VJXAudioFileEntity *)wrap->Value();
