...
- (id)init
{
    ...
    if (self) {
        ...
        [self registerInputPin:@"inputText" withType:kVJXStringPin andSelector:@"setText:"];
        [self registerInputPin:@"fontName" withType:kVJXStringPin andSelector:@"setFontWithName"];
        [self registerInputPin:@"fontSize" withType:kVJXNumberPin andSelector:@"setFontSize"];
        [self registerInputPin:@"fontColor" withType:kVJXNumberPin andSelector:@"setFontColor"];
        [self registerInputPin:@"backgroundColor" withType:kVJXNumberPin andSelector:@"setBackgroundColor"];
        ...
        renderer = [[VJXTextRenderer alloc] init];
    }
    return self;
}
